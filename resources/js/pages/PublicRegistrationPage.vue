                ...
                <section class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
                    ...
                    <div class="grid gap-4 p-4 sm:p-6 md:grid-cols-2">
                        ...
                        <div class="md:col-span-2">
                            <form.Field
                                name="spek_hp_file"
                                :validators="{ onSubmit: ({ value }: any) => (!value ? 'File Spesifikasi HP wajib diunggah' : undefined) }"
                            >
                                <template #default="{ field }">
                                    <div class="space-y-2">
                                        <div class="flex items-center gap-1">
                        ...
                        <div class="md:col-span-2">
                            <form.Field
                                name="follow_ig_file"
                                :validators="{ onSubmit: ({ value }: any) => (!value ? 'File Bukti Follow IG wajib diunggah' : undefined) }"
                            >
                                <template #default="{ field }">
                                    <div class="space-y-2">
                                        <div class="flex items-center gap-1">
