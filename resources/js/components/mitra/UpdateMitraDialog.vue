        ...
        <DialogContent class="max-h-[90vh] overflow-y-auto sm:max-w-[800px]">
            ...
            <form @submit.prevent="form.handleSubmit" class="space-y-4 py-2">
                <div class="grid gap-4 md:grid-cols-2">
                    ...
                    <TanStackInput :form="form" name="pekerjaan" label="Pekerjaan*" placeholder="Contoh: Satpam di Puskesmas Taliwang, Sopir di BNI" />

                    <TanStackCombobox :form="form" name="kode_kec" label="Kecamatan (Sesuai KTP)*" :options="kecamatanSelectOptions" placeholder="Cari kecamatan..." />
                    <TanStackCombobox :form="form" name="kode_desa" label="Desa (Sesuai KTP)*" :options="desaSelectOptions" placeholder="Cari desa..." />
                    
                    <TanStackCombobox :form="form" name="kode_kec_dom" label="Kecamatan Domisili*" :options="kecamatanSelectOptions" placeholder="Cari kecamatan domisili..." />
                    <TanStackCombobox :form="form" name="kode_desa_dom" label="Desa Domisili*" :options="desaDomSelectOptions" placeholder="Cari desa domisili..." />
                    
                    <div class="md:col-span-2">
                        <TanStackInput :form="form" name="alamat_lengkap" label="Alamat Lengkap (Sesuai Domisili)*" placeholder="Masukkan alamat domisili saat ini" />
                    </div>
                    ...
                    <div class="md:col-span-2">
                        <TanStackTextarea :form="form" name="riwayat_kegiatan_bps" label="Riwayat Kegiatan Sensus/Survei" placeholder="Sebutkan semua kegiatan survei/sensus yang pernah diikuti (BPS/Instansi lain) dalam rentang tahun 2020-2026" :rows="3" />
                    </div>
                    ...
                    <div class="flex flex-col gap-3 md:col-span-2">
                        ...
                        <TanStackCheckbox :form="form" name="is_motor" label="Saya memiliki dan/atau menguasai sepeda motor dan siap menggunakannya saat pendaataan" />
                        <TanStackCheckbox v-if="values.jenis_kelamin === 'Perempuan'" :form="form" name="is_not_hamil" label="Saya sedang tidak dalam kondisi hamil" />
                    </div>

                    <div class="col-span-full mt-2 mb-1 border-b border-slate-200"></div>
                    <div class="col-span-full">
                        <h3 class="text-sm font-semibold text-slate-800 uppercase tracking-wider">Status Seleksi</h3>
                    </div>
