...
class PublicRegistrationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'ktp_file' => ['required', 'file', 'mimes:jpg,jpeg,png,webp,pdf', 'max:2048'],
            'spek_hp_file' => ['required', 'file', 'mimes:jpg,jpeg,png,webp,pdf', 'max:2048'],
            'follow_ig_file' => ['required', 'file', 'mimes:jpg,jpeg,png,webp,pdf', 'max:2048'],
