...
class PublicRegistrationOptionalRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'ktp_file' => ['nullable', 'file', 'mimes:jpg,jpeg,png,webp,pdf', 'max:2048'],
            'spek_hp_file' => ['nullable', 'file', 'mimes:jpg,jpeg,png,webp,pdf', 'max:2048'],
            'follow_ig_file' => ['nullable', 'file', 'mimes:jpg,jpeg,png,webp,pdf', 'max:2048'],
            ...
            'kode_kec_dom' => ['nullable', 'string', 'max:7', 'exists:master_kecamatan_desa,kode_kec'],
            'kode_desa_dom' => ['nullable', 'string', 'max:10', 'exists:master_kecamatan_desa,kode_desa'],
